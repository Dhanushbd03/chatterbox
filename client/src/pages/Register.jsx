...
export default function Register() {
	...
	return (
		<>
			<div className="bg-black h-screen w-screen flex flex-col justify-center gap-4 items-center">
				<form
					action=""
					onSubmit={(event) => handleSubmit(event)}
					className="rounded-2xl p-12 flex flex-col gap-2 bg-white md:w-1/4">
